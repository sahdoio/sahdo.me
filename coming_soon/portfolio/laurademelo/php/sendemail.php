...
<html>
	...
	<body data-spy="scroll" data-target="#main-navbar">      
        ...
        <?php
			...
			$site					= "www.iasmaintenance.com";
			$company				= "IAS MAINTENANCE";
			$to           		    = "iasm@iasmaintenance.com";
			//smtp
			$user_name				= "IAS MAINTENANCE";
			$user					= "iasm@iasmaintenance.com";
			$password				= "6241ff";
			$port					= "25";
			$host 					= "iasmaintenance.com";
