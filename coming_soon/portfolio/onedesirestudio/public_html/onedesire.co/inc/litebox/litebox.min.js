    ...
    o.prototype = {
        ...
        populateLitebox: function (t) {
            ...
            if ($litebox.append($loader), null !== i.match(/\.(jpeg|jpg|gif|png|bmp)/i)) {
                ...
                var a = "",
                    r = "?autoplay=1";
                if ("youtube" == videoURL[1] && (a = "http://www.youtube.com/v/" + videoURL[5] + r), "youtu" == videoURL[1] && (a = "http://www.youtube.com/v/" + videoURL[3] + r), "vimeo" == videoURL[1] && (a = "http://player.vimeo.com/video/" + videoURL[3] + r), "dailymotion" == videoURL[1] && (a = "https://www.dailymotion.com/embed/video/" + videoURL[7] + r), "kickstarter" == videoURL[1] && (a = "https://www.kickstarter.com/projects/" + videoURL[9] + "/" + videoURL[10] + "/widget/video.html"), a) {
                    var c = e("<iframe>", {
                        src: a,
                        frameborder: "0",
                        vspace: "0",
