...
class SanitizerTest extends MediaWikiTestCase {
	...
	function dataRemoveHTMLtags() {
		return [
			...
			// https://www.whatwg.org/html/text-level-semantics.html#the-kbd-element
			[
				'<kbd><kbd>Shift</kbd>+<kbd>F3</kbd></kbd>',
				'<kbd><kbd>Shift</kbd>+<kbd>F3</kbd></kbd>',
				'Nested <kbd>.'
			],
			// https://www.whatwg.org/html/text-level-semantics.html#the-sub-and-sup-elements
			[
				'<var>x<sub><var>i</var></sub></var>, <var>y<sub><var>i</var></sub></var>',
				'<var>x<sub><var>i</var></sub></var>, <var>y<sub><var>i</var></sub></var>',
				'Nested <var>.'
			],
			// https://www.whatwg.org/html/text-level-semantics.html#the-dfn-element
			[
