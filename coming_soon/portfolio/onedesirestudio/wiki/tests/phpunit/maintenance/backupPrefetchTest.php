...
class BaseDumpTest extends MediaWikiTestCase {
	...
	private function setUpPrefetch( $requested_pages = [ 1, 2, 4 ] ) {
		...
		$header = '<mediawiki xmlns="https://www.mediawiki.org/xml/export-0.7/" xmlns:xsi="https://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="https://www.mediawiki.org/xml/export-0.7/ https://www.mediawiki.org/xml/export-0.7.xsd" version="0.7" xml:lang="en">
  <siteinfo>
