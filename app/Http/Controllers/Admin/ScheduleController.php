...
class ScheduleController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$member) {
            $result['status'] = 'error';
            $result['message'] = 'Programação não encontrado';
            return response()->json($result);
        }
        ...
        if ($member->save()) {
            $result['status'] = 'ok';
            $result['redirect'] = route('admin.schedule');
            $result['message'] = 'sucesso ao atualzar Programação';
        }
        else {
            $result['status'] = 'error';
            $result['message'] = 'erro ao atualizar Programação';
        }
